...
* Currently, I have collected around 800 FAQs and most of FAQs are very specific to the US and more FAQs data would need to be collected to better serve users who have questions in other areas or live outside the US. In addition, I'd like to share this dataset to the wider audience (e.g. Kaggle, Medium, etc.) and to help accelerate a research or AI development (NLP) in this area
* Lastly, I'd like to enhance the AI models to provide a better response by re-train the AI models from the pretrained ones, providing more embedding data, or integrate with other novel AI models.